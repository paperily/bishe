	...
	<body>
		<div class="container-fluid" id="person_banner">
			<div id="header">
				...
				<div >
					<a href="${ctx}/student/index">登录</a>
				</div>
				<!--个人头像-->
				<div id="userPad">

					<div id="myPhoto">
						<img id="head" src="${sessionScope.student.head}" />
					</div>
		...
		<div class="main_left">
				<div class="image"  id="image"><img id="head" src="${ctx}/img/1.jpg" width="100%" height="100%"></div>
				<div class="image_change" id="image_change">
					<a href="${ctx}/student/change" target="preson_megs" >
					<img src="<%=basePath%>/upload/${sessionScope.student.head}"width="100%" height="100%" >
					<p class="image_text" id="image_text">更换头像</p></a>
				</div>
				<div class="username">用户名：${sessionScope.student.stuName}</div>
				<div class="username_mananger">账户管理</div>
					<div class="usermessage"></div>
					<a  href="${ctx}/student/message" target="preson_megs">
					...
					<a  href="${ctx}/student/reponse" target="preson_megs">
					<div class="usermessage4" >我的回复</div></a>
			</div>
			<div class="main_right">
				<!-- TODO 添加接口，跳转页面  -->
				<iframe src="${ctx }/student/message"  frameborder="0" width="100%" scrolling="no" height="100%" name="preson_megs">
	...
	<script>
  	...
  	<script>	
		function check(){  
		 ...
		 var head = '${sessionScope.student.head }';
	     ...
	     // 2、获得主机地址之后 的目录
	      ...
	      //4.将文件的相对路径与地址做拼接
	      var real_url = localhostPath+"/upload/"+head;//拼接图片的地址栏预览路径

			//alert(real_url);
	      if(real_url != '' && real_url != null){
	    	  $("#head").attr("src",real_url);
	      }
