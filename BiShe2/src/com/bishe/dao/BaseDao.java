...
public abstract class BaseDao<T> {
    ...
    public List<T> findAll() throws Exception {
		Query query=(Query) this.sessionFactory.getCurrentSession().createQuery("from "+entityClass.getSimpleName());
		return query.list();
	}
    ...
    public Long findCount4Page() throws Exception {
		Query query=(Query) this.sessionFactory.getCurrentSession().createQuery("select count("+entityClass.getSimpleName()+"from "+entityClass.getSimpleName());
